...
# Version & progress
This translation is generated from the branch [2.2.0](https://crowdin.com/project/magento-2/ur#/2.2.0) at Crowdin and based on the Magento 2.2.0 sourcefiles.
There have been  1 strings translated of the 8763 strings in the Magento source.
...
composer require magento2translations/language_ur_pk:2.2.0.x-dev
